...
def main():
    ...
    parser.add_argument("--r1", type = str, required = True, nargs = '+', help = "path(s) to the files containing R1 reads (space-separated)")
    parser.add_argument("--r2", type = str, required = True, nargs = '+', help = "path(s) to the files containing R2 reads (space-separated)")
    parser.add_argument("--cellIDs", type = str, required = True, nargs = '+', help = "path(s) to the files containing the IDs of valid cells")
    parser.add_argument("--counts", type = str, required = True, help = "path to the file to save the CaTCH barcode counts into")
